...
exports.numberIncrementer = exports.shuffle = exports.random = void 0;
/**
...
exports.shuffle = function (array, seed) {
    var arrayCopy = [];
    array.forEach(function (i) { return arrayCopy.push(i); });
    ...
    while (m) {
        ...
        i = Math.floor(exports.random(seed) * m--); // <-- MODIFIED LINE
...
exports.numberIncrementer = function (originalNumber) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!true) return [3 /*break*/, 2];
                return [4 /*yield*/, originalNumber++];
            case 1:
                _a.sent();
                return [3 /*break*/, 0];
